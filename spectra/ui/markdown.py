...
_INLINE_CODE_STYLE = (
    ...
    f"padding:2px 5px; border-radius:4px; font-family:'Consolas', 'JetBrains Mono', monospace; font-size:12px;"
)

# ASCII art diagram style
_DIAGRAM_STYLE = (
    f"background-color:{_BLOCK_BG}; color:{_BLOCK_FG}; "
    f"border:1px solid {_CODE_BORDER}; border-radius:6px; "
    f"padding:8px; font-family:'Consolas', 'JetBrains Mono', monospace; "
...
_BLOCK_CODE_STYLE = (
    f"background-color:{_BLOCK_BG}; color:{_BLOCK_FG}; "
    f"border:1px solid {_CODE_BORDER}; border-radius:6px; "
    f"padding:8px 12px; font-family:'Consolas', 'JetBrains Mono', monospace; font-size:12px; "
