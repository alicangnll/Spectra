...
SUSPICIOUS_APIS = {
    ...
    "RegOpenKey": {"category": "registry", "severity": "low", "description": "Opens registry key", "mitre": "T1012"},
    "RegOpenKeyA": {"category": "registry", "severity": "low", "description": "Opens registry key", "mitre": "T1012"},
    "RegOpenKeyW": {"category": "registry", "severity": "low", "description": "Opens registry key", "mitre": "T1012"},
    "RegCloseKey": {"category": "registry", "severity": "low", "description": "Closes registry key", "mitre": "T1012"},
    # File System
    "CreateFile": {
    ...
    "DeleteFile": {"category": "file_system", "severity": "medium", "description": "Deletes file", "mitre": "T1005"},
    "DeleteFileA": {"category": "file_system", "severity": "medium", "description": "Deletes file", "mitre": "T1005"},
    "DeleteFileW": {"category": "file_system", "severity": "medium", "description": "Deletes file", "mitre": "T1005"},
    "CopyFile": {"category": "file_system", "severity": "medium", "description": "Copies file", "mitre": "T1005"},
    "CopyFileA": {"category": "file_system", "severity": "medium", "description": "Copies file", "mitre": "T1005"},
    "CopyFileW": {"category": "file_system", "severity": "medium", "description": "Copies file", "mitre": "T1005"},
    "MoveFile": {"category": "file_system", "severity": "medium", "description": "Moves file", "mitre": "T1005"},
    "MoveFileA": {"category": "file_system", "severity": "medium", "description": "Moves file", "mitre": "T1005"},
    "MoveFileW": {"category": "file_system", "severity": "medium", "description": "Moves file", "mitre": "T1005"},
    "FindFirstFile": {
        "category": "file_system",
        "severity": "low",
    ...
    "socket": {"category": "network", "severity": "medium", "description": "Creates socket", "mitre": "T1071"},
    "connect": {
        "category": "network",
        "severity": "medium",
    ...
    "send": {"category": "network", "severity": "medium", "description": "Sends data over socket", "mitre": "T1071"},
    "recv": {"category": "network", "severity": "medium", "description": "Receives data from socket", "mitre": "T1071"},
    "WSAStartup": {"category": "network", "severity": "low", "description": "Initializes Winsock", "mitre": "T1071"},
    # Crypto
    "CryptAcquireContext": {
        "category": "crypto",
        "severity": "medium",
    ...
    "CryptHashData": {"category": "crypto", "severity": "medium", "description": "Hashes data", "mitre": "T1020"},
    "CryptEncrypt": {"category": "crypto", "severity": "high", "description": "Encrypts data", "mitre": "T1020"},
    "CryptDecrypt": {"category": "crypto", "severity": "high", "description": "Decrypts data", "mitre": "T1020"},
    "CryptGenKey": {
        "category": "crypto",
        "severity": "medium",
    ...
    "CryptImportKey": {"category": "crypto", "severity": "high", "description": "Imports crypto key", "mitre": "T1020"},
    "CryptExportKey": {"category": "crypto", "severity": "high", "description": "Exports crypto key", "mitre": "T1020"},
    "CryptDeriveKey": {
        "category": "crypto",
        "severity": "medium",
...
def get_apis_by_category(category: str) -> list[dict[str, Any]]:
    ...
    """
    return [{**info, "name": name} for name, info in SUSPICIOUS_APIS.items() if info["category"] == category]
...
def get_apis_by_severity(severity: str) -> list[dict[str, Any]]:
    ...
    """
    return [{**info, "name": name} for name, info in SUSPICIOUS_APIS.items() if info["severity"] == severity]
...
def format_suspicious_api_report(apis: list[dict[str, Any]]) -> str:
    ...
    for category in category_order:
        ...
        for api in sorted(category_apis, key=lambda x: x["address"]):
            severity_icon = {"critical": "[CRIT]", "high": "[HIGH]", "medium": "[MED]", "low": "[LOW]"}.get(
                api["severity"], "[?]"
            )
