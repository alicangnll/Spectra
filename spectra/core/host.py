...
def get_user_config_base_dir() -> str:
    """Return user base directory for Spectra config/log files.

    All hosts use ~/.idapro/spectra/ for unified configuration.
    """
    # All hosts use ~/.idapro/spectra/ for unified config storage
    return os.path.join(str(Path.home()), ".idapro", "spectra")
