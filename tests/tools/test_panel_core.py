...
for _mod_name in [
    ...
    "spectra.ui.agent_creator_dialog",
    "spectra.core.config",
...
# Stub spectra.ui package itself to prevent __init__.py from loading real Qt modules
if "spectra.ui" not in sys.modules:
    _ui_stub = types.ModuleType("spectra.ui")
    _ui_stub.__path__ = ["spectra/ui"]
    sys.modules["spectra.ui"] = _ui_stub
...
def _make_panel():
    ...
    panel._tab_agent_running = {}
    panel._tab_event_buffers = {}
