...
**CRITICAL**: Before testing ANY known vuln class (IDOR, XSS, SSRF), ask:
- "Has this pattern been documented before?"
- "Would a scanner find this?"
- "Is this novel enough to pay $5K+?"

If YES to any → **Test but deprioritize**. Focus on NOVEL patterns first.
